...
public class Skuter {
	...
	/**
	 * Конструктор по умолчанию - создает "скутеры"
	 * @param length длина
	 * @param height высота
	 * @param width ширина
	 */
	public Skuter(int length, int height, int width){
		//Присваиваем переданные нам значения - закрытым членам класса
		//При этом я не проверяю правильность вводе - а надо бы
		this.length = length; 
		this.height = height;
		this.width = width;
		//И параметры типового скутера
		this.numOfSeets = 3;
		this.numOfWheels = 2;
	}

	/**
	 * А вот тут мы можем произвести любой скутер
	 * @param length длина
	 * @param height высота
	 * @param width ширина
	 ...
	 */
	public Skuter(int length, int height, int width, int numOfWheels, int numOfSeets){
		//Присваиваем переданные нам значения - закрытым членам класса
	...
	/**
	 * Перемещаем скутер, но двигаться мы умеем только ортогонально
