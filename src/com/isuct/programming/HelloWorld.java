...
public class HelloWorld {
	...
	public static void main(String[] args) {
		...
		double taskB[][]=defaultConstr.taskB(new double[]{0.2,0.3,0.38,0.43,0.57 });
		for (int i=0;i<taskB[0].length;i++){
			System.out.println("X= "+taskB[0][i]+" Y= "+ taskB[1][i]);
		}

		System.out.println("------------Решаем задачу A ------------");
		double taskA[][]=defaultConstr.taskA(0.11, 0.05, 0.36);
		...
		Calc nDefConstr = new Calc(0.11, 0.05, 0.36);
