...
public class MainGui extends JFrame{
	...
	//Кнопка вычислить
	JButton mCalc = new JButton("Рассчитать");
        JButton saveCalc = new JButton("Save");	
	JButton readCalc = new JButton("Read");
	...
	public MainGui() {
		...
		windowContent.add(mCalc, BorderLayout.EAST);
                windowContent.add(saveCalc, BorderLayout.SOUTH);
		windowContent.add(readCalc, BorderLayout.NORTH);
                
		mCalc.addActionListener(new CalculateEngine(this));
                saveCalc.addActionListener(new Save(this)); 
		readCalc.addActionListener(new Reading(this));
