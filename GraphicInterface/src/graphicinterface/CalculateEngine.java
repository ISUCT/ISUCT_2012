...
public class CalculateEngine implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			String params = parent.txtXn.getText()+","+parent.txtDx.getText()+","+parent.txtXk.getText();
...
//            Logger.getLogger(CalculateEngine.class.getName()).log(Level.SEVERE, null, ex);
//
//        }
		} catch (IOException ex) {
			parent.txtResult.setText("Заполните все поля");
		}
